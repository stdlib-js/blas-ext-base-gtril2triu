...
```javascript
import gtril2triu from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gtril2triu@esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gtril2triu@esm/index.mjs';
```
